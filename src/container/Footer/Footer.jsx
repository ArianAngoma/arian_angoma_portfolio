    ...
    <>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card ">
          ...
          <a href="mailto:arian.angoma.js@gmail.com"
            className="p-text">arian.angoma.js@gmail.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="phone"/>
          <a href="tel:+51 983 416 698" className="p-text">+51 983 416 698</a>
        </div>
      </div>
      {
        !isFormSubmitted ? (
...
export const FooterAppWrap = AppWrap(
    // eslint-disable-next-line new-cap
